...
class OilInventoryDashboardController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $totalRecords = $this->getTotalRecords($storeFilter, $dateFrom, $dateTo);
        ...
        $data = [
            ...
            'statusStats' => $totalRecords > 0 ? $this->getStatusStats($storeFilter, $dateFrom, $dateTo) : [],
            'monthlyStats' => $totalRecords > 0 ? $this->getMonthlyStats($storeFilter, $dateFrom, $dateTo) : [],
            'averageConsumption' => $totalRecords > 0 ? $this->getAverageConsumption($storeFilter, $dateFrom, $dateTo) : [
                'avg_apparatus' => 0,
                'avg_new_oil' => 0,
                'avg_evaporation' => 0,
                'avg_return' => 0,
            ...
            'weeklyTrend' => $totalRecords > 0 ? $this->getWeeklyTrend($storeFilter, $dateFrom, $dateTo) : [],
            'topConsumptionDays' => $totalRecords > 0 ? $this->getTopConsumptionDays($storeFilter, $dateFrom, $dateTo) : [],
            'recentRecords' => $totalRecords > 0 ? $this->getRecentRecords($storeFilter, $dateFrom, $dateTo) : [],
            'wastageAnalysis' => $totalRecords > 0 ? $this->getWastageAnalysis($storeFilter, $dateFrom, $dateTo) : [
                'avg_evaporation' => 0,
                'max_evaporation' => 0,
                'min_evaporation' => 0,
                'total_evaporation' => 0,
            ...
            'efficiencyMetrics' => $totalRecords > 0 ? $this->getEfficiencyMetrics($storeFilter, $dateFrom, $dateTo) : [
     ...
     */
    private function getStatusStats($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = OilInventory::find()
     ...
     */
    private function getMonthlyStats($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = (new Query())
            ->select([
     ...
     */
    private function getAverageConsumption($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = (new Query())
            ->select([
     ...
     */
    private function getWeeklyTrend($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = (new Query())
            ->select([
        ...
        if (!$dateFrom && !$dateTo) {
            $query->andWhere(['>=', 'DATE(created_at)', date('Y-m-d', strtotime('-7 days'))]);
        } else {
            if ($dateFrom) {
                $query->andWhere(['>=', 'DATE(created_at)', $dateFrom]);
            }
     ...
     */
    private function getTopConsumptionDays($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = (new Query())
            ->select([
                'DATE(created_at) as date',
            ...
            ->from('oil_inventory')
            ->andWhere(['!=', 'status', OilInventory::STATUS_NEW])
            ->orderBy(['(apparatus + new_oil + evaporation + return_amount)' => SORT_DESC])
            ->limit(10);
     ...
     */
    private function getRecentRecords($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = OilInventory::find()
     ...
     */
    private function getWastageAnalysis($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = (new Query())
            ->select([
                'AVG(evaporation) as avg_evaporation',
     ...
     */
    private function getEfficiencyMetrics($storeFilter = null, $dateFrom = null, $dateTo = null)
    {
        $query = (new Query())
            ->select([
