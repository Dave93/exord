...
HTML;
    ...
    $content .= $this->render('_supplier-tab', [
        'order' => $order,
        'products' => $products,
        'active' => $active
    ]);
...
<div class="card">
    <div class="header clearfix">
        ...
        <p class="pull-right">
            <?= Html::a('Excel', ['supplier-excel'], ['class' => 'btn btn-success btn-fill']) ?>
            <?= Html::a('По продуктам', ['buyer-by-product'], ['class' => 'btn btn-primary btn-fill']) ?>
        </p>
    </div>
    <hr>
