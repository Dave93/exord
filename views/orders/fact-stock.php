...
$this->title = "Приход со склада на заказ: #" . $model->id;
...
foreach ($items as $item) {
    ...
    $list .= <<<HTML
        <tr>
            ...
            <td class="text-center">{$item['storeQuantity']}</td>
            <td width="200">
    ...
    <div class="content table-responsive">
        <div class="orders-list">
            <?php if (!empty($list)): ?>
                ...
                <?php ActiveForm::end(); ?>
            <?php else: ?>
                <p class="warning alert alert-danger">Вашего заказа еще не подтвердил Складщик</p>
            <?php endif; ?>
        </div>
    </div>
</div>
