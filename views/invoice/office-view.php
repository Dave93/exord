...
$this->title = "Заказ #" . $model->id." - ".$model->user->fullname;
        ...
        <div class="table-responsive mb20">
            ...
            <?= GridView::widget([
                ...
                'rowOptions' => function ($model) {
                    ...
                    $class = "";
                    if ($model->factStoreQuantity != $model->shipped_from_warehouse) {
                        $class = "bg-danger";
                    }
                    return ['class' => $class];
                },
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'content' => function ($prod) {
                            $inputName = 'data[' . $prod->productId . '][factOfficeQuantity]';
                            return Html::input('number', $inputName, ($prod->factStoreQuantity ?: 0), ['class' => 'form-control w130 factOfficeQuantity', 'data-va' => 'davr', 'min' => 0.000, "step" => "any"]);
                        }
                    ],
                ],
            ]); ?>
            <hr />
            <?= $form->field($model, 'office_comment')->textarea(['rows' => 7]) ?>
