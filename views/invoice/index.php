...
<div class="card">
    ...
    <hr>
    <div class="content">
        <h4><?=date('d.m.Y', strtotime($model->date))?></h4>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'content' => function ($model) {
                            ...
                            return Html::input('number', $inputName, $model->factStoreQuantity ?: 0, ['class' => 'form-control w130 factStoreQuantity', 'min' => 0.000, "step" => "any"]);
                        }
                    ],
                    [
                        'class' => 'yii\grid\Column',
                        ...
                        'header' => 'Возврат',
                        'content' => function ($model) {
                            $inputName = 'data[' . $model->productId . '][returnQuantity]';
                            return Html::input('number', $inputName, $model->returned_quantity ?: 0, ['class' => 'form-control w130 returnQuantity', 'min' => 0.000, "step" => "any"]);
                        }
                    ],
                ],
            ]); ?>
...
<script>
    $(document).ready(function () {
        ...
        //     $('.factStoreQuantity').each(function(){
        //        if ($(this).val() == 0) {
        //            e.preventDefault();
        //            e.stopPropagation();
        //            Toast.show({
        //                   message: 'Поле "По факту" не может быть пустым',
