...
$this->title = "Создание заявки на перемещение";
...
var storeCounter = 0;
var storeData = {}; // { storeId: { products: { productId: true } } }
...
function addProductRow(storeId, productId, productName, productUnit) {
    ...
    html += '<td><input type="number" class="form-control quantity-input" name="transfers[' + storeId + '][' + productId + ']" value="" step="any" min="0.01" /></td>';
...
<div class="card">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="comment" rows="3" placeholder="Добавьте комментарий к заявке..."></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="form-group">
                    <?= Html::submitButton('Создать заявку', ['class' => 'btn btn-success btn-fill btn-lg']) ?>
