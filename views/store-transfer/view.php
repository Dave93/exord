...
<div class="card">
    <div class="header">
        <h4 class="title">
            ...
            <?= Html::a('Назад к списку', Yii::$app->request->get('returnUrl', Yii::$app->urlManager->createUrl([$isAdmin ? 'store-transfer/admin-index' : 'store-transfer/index'])), ['class' => 'btn btn-default']) ?>
            </span>
        </h4>
    </div>
    <div class="content">
