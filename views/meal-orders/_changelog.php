            ...
            <tbody>
                <?php foreach ($changelog as $change): ?>
                    ...
                    switch ($change->action) {
                        case MealOrderItemsChangelog::ACTION_ADDED:
                            $badgeClass = 'badge-success';
                            break;
                        case MealOrderItemsChangelog::ACTION_DELETED:
                            $badgeClass = 'badge-danger';
                            break;
                        case MealOrderItemsChangelog::ACTION_UPDATED:
                            $badgeClass = 'badge-warning';
                            break;
                        case MealOrderItemsChangelog::ACTION_RESTORED:
                    ...
                    <tr>
                        ...
                        <td><?= Html::encode($change->dish->name ?? 'Блюдо удалено') ?></td>
                        <td>
